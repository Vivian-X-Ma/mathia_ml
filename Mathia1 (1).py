...
print(agg_dfmerge[['Anon.Student.Id', 'total_attempts', 'correct_attempts', 'correct_attempt_ratio']].head())
...
features = [
    'workspace_total_time_seconds', 'step_by_step_problems_completed',
    'problems_completed', 'hint_count', 'error_count',
    'skills', 'aplse',
    'total_attempts', 'correct_attempts', 'correct_attempt_ratio'
]
